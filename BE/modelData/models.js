/**
 * File này chứa dữ liệu mẫu để dbLoad.js nạp vào MongoDB.
 * Sau khi nạp xong, app chạy bằng dữ liệu trong database chứ không đọc trực tiếp file này.
 */
...
// Khối này tạo danh sách user mẫu.
...
// Khối này tạo danh sách ảnh mẫu.
const photo1 = {
...
// Khối này tạo danh sách comment mẫu.
const comment1 = {
...
comments.forEach(function (comment) {
  ...
  })[0]; // Khối lọc này chỉ lấy một photo khớp với photo_id của comment.
